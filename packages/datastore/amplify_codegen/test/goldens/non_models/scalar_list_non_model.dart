...
abstract class ScalarListNonModel extends PartialScalarListNonModel
  ...
  static QueryField<String, ScalarListNonModel, String> get $id =>
      _queryFields.$id;

  /// Query field for the [id] field.
  @Deprecated(r'Use $id instead')
  static QueryField<String, ScalarListNonModel, String> get ID => $id;
  @override
  List<String?>? get listOfString;

  /// Query field for the [listOfString] field.
  static QueryField<String, ScalarListNonModel, String?> get $listOfString =>
      _queryFields.$listOfString;

  /// Query field for the [listOfString] field.
  @Deprecated(r'Use $listOfString instead')
  static QueryField<String, ScalarListNonModel, String?> get LIST_OF_STRING =>
      $listOfString;
  @override
  List<String>? get listOfRequiredString;

  /// Query field for the [listOfRequiredString] field.
  static QueryField<String, ScalarListNonModel, String>
  ...
  static QueryField<String, ScalarListNonModel, int?> get $listOfInteger =>
      _queryFields.$listOfInteger;

  /// Query field for the [listOfInteger] field.
  @Deprecated(r'Use $listOfInteger instead')
  static QueryField<String, ScalarListNonModel, int?> get LIST_OF_INTEGER =>
      $listOfInteger;
  @override
  List<int>? get listOfRequiredInteger;

  /// Query field for the [listOfRequiredInteger] field.
  static QueryField<String, ScalarListNonModel, int>
  ...
  static QueryField<String, ScalarListNonModel, double?> get $listOfFloat =>
      _queryFields.$listOfFloat;

  /// Query field for the [listOfFloat] field.
  @Deprecated(r'Use $listOfFloat instead')
  static QueryField<String, ScalarListNonModel, double?> get LIST_OF_FLOAT =>
      $listOfFloat;
  @override
  List<double>? get listOfRequiredFloat;

  /// Query field for the [listOfRequiredFloat] field.
  static QueryField<String, ScalarListNonModel, double>
  ...
  static QueryField<String, ScalarListNonModel, bool?> get $listOfBoolean =>
      _queryFields.$listOfBoolean;

  /// Query field for the [listOfBoolean] field.
  @Deprecated(r'Use $listOfBoolean instead')
  static QueryField<String, ScalarListNonModel, bool?> get LIST_OF_BOOLEAN =>
      $listOfBoolean;
  @override
  List<bool>? get listOfRequiredBoolean;

  /// Query field for the [listOfRequiredBoolean] field.
  static QueryField<String, ScalarListNonModel, bool>
  ...
  static QueryField<String, ScalarListNonModel, TemporalDate?>
  ...
  static QueryField<String, ScalarListNonModel, TemporalDateTime?>
  ...
  static QueryField<String, ScalarListNonModel, TemporalTime?>
  ...
  static QueryField<String, ScalarListNonModel, TemporalTimestamp?>
  ...
  static QueryField<String, ScalarListNonModel, String?> get $listOfAwsEmail =>
  ...
  static QueryField<String, ScalarListNonModel, Object?> get $listOfAwsjson =>
      _queryFields.$listOfAwsjson;

  /// Query field for the [listOfAwsjson] field.
  @Deprecated(r'Use $listOfAwsjson instead')
  static QueryField<String, ScalarListNonModel, Object?> get LIST_OF_AWSJSON =>
      $listOfAwsjson;
  @override
  List<Object>? get listOfRequiredAwsjson;

  /// Query field for the [listOfRequiredAwsjson] field.
  static QueryField<String, ScalarListNonModel, Object>
  ...
  static QueryField<String, ScalarListNonModel, String?> get $listOfAwsPhone =>
  ...
  static QueryField<String, ScalarListNonModel, Uri?> get $listOfAwsUrl =>
      _queryFields.$listOfAwsUrl;

  /// Query field for the [listOfAwsUrl] field.
  @Deprecated(r'Use $listOfAwsUrl instead')
  static QueryField<String, ScalarListNonModel, Uri?> get LIST_OF_AWS_URL =>
      $listOfAwsUrl;
  @override
  List<Uri>? get listOfRequiredAwsUrl;

  /// Query field for the [listOfRequiredAwsUrl] field.
  static QueryField<String, ScalarListNonModel, Uri>
  ...
  static QueryField<String, ScalarListNonModel, String> get $modelIdentifier =>
      _queryFields.$modelIdentifier;

  /// Query field for the [modelIdentifier] field.
  @Deprecated(r'Use $modelIdentifier instead')
  static QueryField<String, ScalarListNonModel, String> get MODEL_IDENTIFIER =>
      $modelIdentifier;
