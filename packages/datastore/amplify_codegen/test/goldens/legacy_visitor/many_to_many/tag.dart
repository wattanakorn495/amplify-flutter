...
abstract class Tag extends PartialTag
    with LegacyModelFields<String, Tag>
    implements Model<String, Tag> {
  factory Tag({
    String? id,
  ...
  static QueryField<String, Tag, String> get $id => _queryFields.$id;

  /// Query field for the [id] field.
  @Deprecated(r'Use $id instead')
  static QueryField<String, Tag, String> get ID => $id;
  @override
  String get label;

  /// Query field for the [label] field.
  static QueryField<String, Tag, String> get $label => _queryFields.$label;

  /// Query field for the [label] field.
  @Deprecated(r'Use $label instead')
  static QueryField<String, Tag, String> get LABEL => $label;
  @override
  AsyncModelCollection<String, Post, PartialPost, Post>? get posts;

  /// Query field for the [posts] field.
  static PostQueryFields<String, Tag> get $posts => _queryFields.$posts;

  /// Query field for the [posts] field.
  @Deprecated(r'Use $posts instead')
  static PostQueryFields<String, Tag> get POSTS => $posts;
  @override
  TemporalDateTime get createdAt;
  @override
  TemporalDateTime get updatedAt;
  ...
  static QueryField<String, Tag, String> get $modelIdentifier =>
      _queryFields.$modelIdentifier;

  /// Query field for the [modelIdentifier] field.
  @Deprecated(r'Use $modelIdentifier instead')
  static QueryField<String, Tag, String> get MODEL_IDENTIFIER =>
      $modelIdentifier;
  Tag copyWith({
    String? id,
    String? label,
