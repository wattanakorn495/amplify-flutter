...
class ModelProvider extends ModelProviderInterface {
  ...
  @override
  String get version => '72b88c396146ae26573f56880a2ee141';
  @override
  ...
  ModelType<ModelIdentifier, M, P> getModelType<
    ...
    switch (modelName) {
      ...
      case 'Tag':
        return (Tag.classType as ModelType<ModelIdentifier, M, P>);
      case 'PostTags':
        return (PostTags.classType as ModelType<ModelIdentifier, M, P>);
      default:
        throw ArgumentError(
