...
abstract class SimpleModel extends PartialSimpleModel
  ...
  static QueryField<String, SimpleModel, String?> get $name =>
      _queryFields.$name;

  /// Query field for the [name] field.
  @Deprecated(r'Use $name instead')
  static QueryField<String, SimpleModel, String?> get NAME => $name;
  @override
  String? get bar;

  /// Query field for the [bar] field.
  static QueryField<String, SimpleModel, String?> get $bar => _queryFields.$bar;

  /// Query field for the [bar] field.
  @Deprecated(r'Use $bar instead')
  static QueryField<String, SimpleModel, String?> get BAR => $bar;
  @override
  TemporalDateTime get createdAt;
  @override
  TemporalDateTime get updatedAt;
