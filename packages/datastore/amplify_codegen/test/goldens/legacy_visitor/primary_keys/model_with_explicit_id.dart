...
abstract class ModelWithExplicitId extends PartialModelWithExplicitId
  ...
  static QueryField<String, ModelWithExplicitId, String> get $id =>
      _queryFields.$id;

  /// Query field for the [id] field.
  @Deprecated(r'Use $id instead')
  static QueryField<String, ModelWithExplicitId, String> get ID => $id;
  @override
  String get title;

  /// Query field for the [title] field.
  static QueryField<String, ModelWithExplicitId, String> get $title =>
      _queryFields.$title;

  /// Query field for the [title] field.
  @Deprecated(r'Use $title instead')
  static QueryField<String, ModelWithExplicitId, String> get TITLE => $title;
  @override
  TemporalDateTime get createdAt;
  @override
  TemporalDateTime get updatedAt;
  ...
  static QueryField<String, ModelWithExplicitId, String> get $modelIdentifier =>
      _queryFields.$modelIdentifier;

  /// Query field for the [modelIdentifier] field.
  @Deprecated(r'Use $modelIdentifier instead')
  static QueryField<String, ModelWithExplicitId, String> get MODEL_IDENTIFIER =>
      $modelIdentifier;
