...
class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestEc2QuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object
        as DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest);
    final result = <Object?>[
    ...
    if (payload.localGatewayRouteTableVirtualInterfaceGroupAssociationIds !=
        null) {
      result
        ...
        ..add(const _i1.XmlBuiltListSerializer(
          ...
          serializers,
          payload.localGatewayRouteTableVirtualInterfaceGroupAssociationIds!,
