...
library amplify_logging_dart.cloud_watch_logs.operation.put_metric_filter_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutMetricFilterOperation extends _i1.HttpOperation<
    _i2.PutMetricFilterRequest,
    _i2.PutMetricFilterRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Creates or updates a metric filter and associates it with the specified log group. Metric filters allow you to configure rules to extract metric data from log events ingested through [PutLogEvents](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutLogEvents.html).
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.PutMetricFilterRequest, _i2.PutMetricFilterRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutMetricFilterRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'PutMetricFilter';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.PutMetricFilterRequest input, {
