...
library amplify_logging_dart.cloud_watch_logs.operation.stop_query_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class StopQueryOperation extends _i1.HttpOperation<_i2.StopQueryRequest,
    _i2.StopQueryRequest, _i3.StopQueryResponse, _i3.StopQueryResponse> {
  /// Stops a CloudWatch Logs Insights query that is in progress. If the query has already ended, the operation returns an error indicating that the specified query is not running.
  StopQueryOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.StopQueryRequest, _i2.StopQueryRequest,
          _i3.StopQueryResponse, _i3.StopQueryResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.StopQueryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.StopQueryResponse? output]) => 200;
  @override
  _i3.StopQueryResponse buildOutput(
    _i3.StopQueryResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.StopQueryResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'StopQuery';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.StopQueryResponse> run(
    _i2.StopQueryRequest input, {
