...
library amplify_logging_dart.cloud_watch_logs.operation.put_subscription_filter_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutSubscriptionFilterOperation extends _i1.HttpOperation<
    _i2.PutSubscriptionFilterRequest,
    _i2.PutSubscriptionFilterRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Creates or updates a subscription filter and associates it with the specified log group. Subscription filters allow you to subscribe to a real-time stream of log events ingested through [PutLogEvents](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutLogEvents.html) and have them delivered to a specific destination. When log events are sent to the receiving service, they are Base64 encoded and compressed with the gzip format.
  ...
  ///
  /// To perform a `PutSubscriptionFilter` operation, you must also have the `iam:PassRole` permission.
  PutSubscriptionFilterOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.PutSubscriptionFilterRequest,
          _i2.PutSubscriptionFilterRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutSubscriptionFilterRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'PutSubscriptionFilter';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.PutSubscriptionFilterRequest input, {
