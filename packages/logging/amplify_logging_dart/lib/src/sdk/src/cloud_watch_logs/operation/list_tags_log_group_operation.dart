...
library amplify_logging_dart.cloud_watch_logs.operation.list_tags_log_group_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListTagsLogGroupOperation extends _i1.HttpOperation<
    _i2.ListTagsLogGroupRequest,
    _i2.ListTagsLogGroupRequest,
    _i3.ListTagsLogGroupResponse,
    _i3.ListTagsLogGroupResponse> {
  /// The ListTagsLogGroup operation is on the path to deprecation. We recommend that you use [ListTagsForResource](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_ListTagsForResource.html) instead.
  ///
  /// Lists the tags for the specified log group.
  ListTagsLogGroupOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ListTagsLogGroupRequest,
          _i3.ListTagsLogGroupResponse,
          _i3.ListTagsLogGroupResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListTagsLogGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListTagsLogGroupResponse? output]) => 200;
  @override
  _i3.ListTagsLogGroupResponse buildOutput(
    _i3.ListTagsLogGroupResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ListTagsLogGroupResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ListTagsLogGroup';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListTagsLogGroupResponse> run(
    _i2.ListTagsLogGroupRequest input, {
