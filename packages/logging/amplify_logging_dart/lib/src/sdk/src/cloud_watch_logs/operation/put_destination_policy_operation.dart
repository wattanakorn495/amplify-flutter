...
library amplify_logging_dart.cloud_watch_logs.operation.put_destination_policy_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutDestinationPolicyOperation extends _i1.HttpOperation<
    _i2.PutDestinationPolicyRequest,
    _i2.PutDestinationPolicyRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Creates or updates an access policy associated with an existing destination. An access policy is an [IAM policy document](https://docs.aws.amazon.com/IAM/latest/UserGuide/policies_overview.html) that is used to authorize claims to register a subscription filter against a given destination.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.PutDestinationPolicyRequest,
          _i2.PutDestinationPolicyRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutDestinationPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'PutDestinationPolicy';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.PutDestinationPolicyRequest input, {
