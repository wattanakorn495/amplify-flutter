...
library amplify_logging_dart.cloud_watch_logs.operation.describe_export_tasks_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeExportTasksOperation extends _i1.HttpOperation<
    ...
    _i2.DescribeExportTasksRequest,
    _i3.DescribeExportTasksResponse,
    _i3.DescribeExportTasksResponse> {
  /// Lists the specified export tasks. You can list all your export tasks or filter the results based on task ID or task status.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeExportTasksRequest,
          _i3.DescribeExportTasksResponse,
          _i3.DescribeExportTasksResponse>> protocols = [
  ...
  @override
  int successCode([_i3.DescribeExportTasksResponse? output]) => 200;
  @override
  _i3.DescribeExportTasksResponse buildOutput(
    _i3.DescribeExportTasksResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeExportTasksResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeExportTasksResponse> run(
