...
library amplify_logging_dart.cloud_watch_logs.operation.delete_destination_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteDestinationOperation extends _i1.HttpOperation<
    _i2.DeleteDestinationRequest,
    _i2.DeleteDestinationRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Deletes the specified destination, and eventually disables all the subscription filters that publish to it. This operation does not delete the physical resource encapsulated by the destination.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.DeleteDestinationRequest,
          _i2.DeleteDestinationRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteDestinationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteDestination';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.DeleteDestinationRequest input, {
