...
library amplify_logging_dart.cloud_watch_logs.operation.untag_log_group_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UntagLogGroupOperation extends _i1.HttpOperation<_i2.UntagLogGroupRequest,
    _i2.UntagLogGroupRequest, _i1.Unit, _i1.Unit> {
  /// The UntagLogGroup operation is on the path to deprecation. We recommend that you use [UntagResource](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_UntagResource.html) instead.
  ///
  /// Removes the specified tags from the specified log group.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UntagLogGroupRequest, _i2.UntagLogGroupRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UntagLogGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'UntagLogGroup';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.UntagLogGroupRequest input, {
