...
library amplify_logging_dart.cloud_watch_logs.model.resource_already_exists_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class ResourceAlreadyExistsException
  ...
  static const List<_i2.SmithySerializer> serializers = [
    ResourceAlreadyExistsExceptionAwsJson11Serializer()
  ];
  ...
  String toString() {
    final helper =
        newBuiltValueToStringHelper('ResourceAlreadyExistsException');
    helper.add(
      'message',
      message,
    );
...
class ResourceAlreadyExistsExceptionAwsJson11Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as ResourceAlreadyExistsException);
    final result = <Object?>[];
