...
library amplify_logging_dart.cloud_watch_logs.operation.describe_queries_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeQueriesOperation extends _i1.HttpOperation<
    _i2.DescribeQueriesRequest,
    _i2.DescribeQueriesRequest,
    _i3.DescribeQueriesResponse,
    _i3.DescribeQueriesResponse> {
  /// Returns a list of CloudWatch Logs Insights queries that are scheduled, executing, or have been executed recently in this account. You can request all queries or limit it to queries of a specific log group or queries with a certain status.
  DescribeQueriesOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeQueriesRequest,
          _i3.DescribeQueriesResponse,
          _i3.DescribeQueriesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeQueriesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeQueriesResponse? output]) => 200;
  @override
  _i3.DescribeQueriesResponse buildOutput(
    _i3.DescribeQueriesResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeQueriesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DescribeQueries';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeQueriesResponse> run(
    _i2.DescribeQueriesRequest input, {
