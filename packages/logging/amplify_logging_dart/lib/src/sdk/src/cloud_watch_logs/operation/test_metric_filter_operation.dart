...
library amplify_logging_dart.cloud_watch_logs.operation.test_metric_filter_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class TestMetricFilterOperation extends _i1.HttpOperation<
    _i2.TestMetricFilterRequest,
    _i2.TestMetricFilterRequest,
    _i3.TestMetricFilterResponse,
    _i3.TestMetricFilterResponse> {
  /// Tests the filter pattern of a metric filter against a sample of log event messages. You can use this operation to validate the correctness of a metric filter pattern.
  TestMetricFilterOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.TestMetricFilterRequest,
          _i3.TestMetricFilterResponse,
          _i3.TestMetricFilterResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.TestMetricFilterRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.TestMetricFilterResponse? output]) => 200;
  @override
  _i3.TestMetricFilterResponse buildOutput(
    _i3.TestMetricFilterResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.TestMetricFilterResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'TestMetricFilter';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.TestMetricFilterResponse> run(
    _i2.TestMetricFilterRequest input, {
