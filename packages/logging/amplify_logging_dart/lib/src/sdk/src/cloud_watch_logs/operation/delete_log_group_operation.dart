...
library amplify_logging_dart.cloud_watch_logs.operation.delete_log_group_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteLogGroupOperation extends _i1.HttpOperation<
    _i2.DeleteLogGroupRequest, _i2.DeleteLogGroupRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the specified log group and permanently deletes all the archived log events associated with the log group.
  DeleteLogGroupOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.DeleteLogGroupRequest, _i2.DeleteLogGroupRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteLogGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteLogGroup';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.DeleteLogGroupRequest input, {
