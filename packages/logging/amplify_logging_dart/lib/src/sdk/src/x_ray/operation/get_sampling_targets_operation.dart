...
library amplify_logging_dart.x_ray.operation.get_sampling_targets_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetSamplingTargetsOperation extends _i1.HttpOperation<
    _i2.GetSamplingTargetsRequest,
    _i2.GetSamplingTargetsRequest,
    _i3.GetSamplingTargetsResult,
    _i3.GetSamplingTargetsResult> {
  /// Requests a sampling quota for rules that the service is using to sample requests.
  GetSamplingTargetsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetSamplingTargetsRequest,
          _i3.GetSamplingTargetsResult,
          _i3.GetSamplingTargetsResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetSamplingTargetsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/SamplingTargets';
      });
  @override
  int successCode([_i3.GetSamplingTargetsResult? output]) => 200;
  @override
  _i3.GetSamplingTargetsResult buildOutput(
    _i3.GetSamplingTargetsResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.GetSamplingTargetsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetSamplingTargets';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.GetSamplingTargetsResult> run(
    _i2.GetSamplingTargetsRequest input, {
