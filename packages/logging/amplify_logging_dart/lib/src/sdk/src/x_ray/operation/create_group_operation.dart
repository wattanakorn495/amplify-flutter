...
library amplify_logging_dart.x_ray.operation.create_group_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateGroupOperation extends _i1.HttpOperation<_i2.CreateGroupRequest,
    _i2.CreateGroupRequest, _i3.CreateGroupResult, _i3.CreateGroupResult> {
  /// Creates a group resource with a name and a filter expression.
  ...
  late final List<
      _i1.HttpProtocol<_i2.CreateGroupRequest, _i2.CreateGroupRequest,
          _i3.CreateGroupResult, _i3.CreateGroupResult>> protocols = [
  ...
  _i1.HttpRequest buildRequest(_i2.CreateGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/CreateGroup';
      });
  @override
  int successCode([_i3.CreateGroupResult? output]) => 200;
  @override
  _i3.CreateGroupResult buildOutput(
    _i3.CreateGroupResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateGroupResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateGroupResult> run(
