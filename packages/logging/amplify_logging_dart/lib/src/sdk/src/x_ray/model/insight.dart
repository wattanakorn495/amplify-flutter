...
library amplify_logging_dart.x_ray.model.insight; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class Insight
    with _i1.AWSEquatable<Insight>
    implements Built<Insight, InsightBuilder> {
  /// When fault rates go outside of the expected range, X-Ray creates an insight. Insights tracks emergent issues within your applications.
  factory Insight({
  ...
  /// When fault rates go outside of the expected range, X-Ray creates an insight. Insights tracks emergent issues within your applications.
  factory Insight.build([void Function(InsightBuilder) updates]) = _$Insight;

  const Insight._();

  static const List<_i8.SmithySerializer> serializers = [
    InsightRestJson1Serializer()
  ];

  @BuiltValueHook(initializeBuilder: true)
  static void _init(InsightBuilder b) {}
  ...
  @override
  String toString() {
    final helper = newBuiltValueToStringHelper('Insight');
    helper.add(
      'categories',
      categories,
    );
...
class InsightRestJson1Serializer
    extends _i8.StructuredSmithySerializer<Insight> {
  const InsightRestJson1Serializer() : super('Insight');
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as Insight);
    final result = <Object?>[];
