...
library amplify_logging_dart.x_ray.model.malformed_policy_document_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class MalformedPolicyDocumentException
  ...
  static const List<_i2.SmithySerializer> serializers = [
    MalformedPolicyDocumentExceptionRestJson1Serializer()
  ];
...
class MalformedPolicyDocumentExceptionRestJson1Serializer
    extends _i2.StructuredSmithySerializer<MalformedPolicyDocumentException> {
  const MalformedPolicyDocumentExceptionRestJson1Serializer()
