...
library amplify_logging_dart.x_ray.operation.create_sampling_rule_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateSamplingRuleOperation extends _i1.HttpOperation<
    _i2.CreateSamplingRuleRequest,
    _i2.CreateSamplingRuleRequest,
    _i3.CreateSamplingRuleResult,
    _i3.CreateSamplingRuleResult> {
  /// Creates a rule to control sampling behavior for instrumented applications. Services retrieve rules with [GetSamplingRules](https://docs.aws.amazon.com/xray/latest/api/API_GetSamplingRules.html), and evaluate each rule in ascending order of _priority_ for each request. If a rule matches, the service records a trace, borrowing it from the reservoir size. After 10 seconds, the service reports back to X-Ray with [GetSamplingTargets](https://docs.aws.amazon.com/xray/latest/api/API_GetSamplingTargets.html) to get updated versions of each in-use rule. The updated rule contains a trace quota that the service can use instead of borrowing from the reservoir.
  CreateSamplingRuleOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateSamplingRuleRequest,
          _i3.CreateSamplingRuleResult,
          _i3.CreateSamplingRuleResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateSamplingRuleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/CreateSamplingRule';
      });
  @override
  int successCode([_i3.CreateSamplingRuleResult? output]) => 200;
  @override
  _i3.CreateSamplingRuleResult buildOutput(
    _i3.CreateSamplingRuleResult payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateSamplingRuleResult.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError(
          ...
          _i1.ErrorKind.client,
          _i10.RuleLimitExceededException,
          builder: _i10.RuleLimitExceededException.fromResponse,
        ),
        _i1.SmithyError(
          _i1.ShapeId(
            namespace: 'com.amazonaws.xray',
  ...
  @override
  String get runtimeTypeName => 'CreateSamplingRule';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateSamplingRuleResult> run(
    _i2.CreateSamplingRuleRequest input, {
