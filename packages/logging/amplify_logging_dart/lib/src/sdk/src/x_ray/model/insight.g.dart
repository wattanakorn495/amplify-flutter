...
part of amplify_logging_dart.x_ray.model.insight;
...
class _$Insight extends Insight {
  ...
  factory _$Insight([void Function(InsightBuilder)? updates]) =>
      (new InsightBuilder()..update(updates))._build();
  ...
  @override
  InsightBuilder toBuilder() => new InsightBuilder()..replace(this);
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Insight', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
