...
library amplify_logging_dart.x_ray.operation.tag_resource_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class TagResourceOperation extends _i1.HttpOperation<_i2.TagResourceRequest,
    _i2.TagResourceRequest, _i3.TagResourceResponse, _i3.TagResourceResponse> {
  /// Applies tags to an existing Amazon Web Services X-Ray group or sampling rule.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.TagResourceRequest, _i2.TagResourceRequest,
  ...
  _i1.HttpRequest buildRequest(_i2.TagResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/TagResource';
      });
  @override
  int successCode([_i3.TagResourceResponse? output]) => 200;
  @override
  _i3.TagResourceResponse buildOutput(
    _i3.TagResourceResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.TagResourceResponse.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError(
          ...
          _i1.ErrorKind.client,
          _i12.TooManyTagsException,
          statusCode: 400,
          builder: _i12.TooManyTagsException.fromResponse,
        ),
      ];
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.TagResourceResponse> run(
